...
from .gstr9 import generate_gstr9
    ...
    for rt in return_types:
        ...
        try:
            match rt:
                ...
                #      generated_reports.append({"return_type": rt, "report": output_file})
                # case "GSTR-3B":
                #      await generate_gstr3b_merged(input_dir, output_dir)
                #      generated_reports.append({"return_type": rt, "report": output_file})
                case "GSTR-9":
                     await generate_gstr9(input_dir, output_dir)
                     # generated_reports.append({"return_type": rt, "report": output_file})
                # case "EWB-IN":
                ...
                #      generated_reports.append({"return_type": rt, "report": output_file})
                case _: print(f" Not a valid return type  {rt}")
