...
async def generate_gstr9_Vs_3B_analysis(gstin, valuesFrom3b, valuesFrom9):
    final_result_points = {}
    ...
    try:
        ...
        try:
            ...
            row_cursor += 1
            print(f"[GSTR-9_Vs_3B Analysis] Error getting Table_4_row_G value from GSTR-9: {e}")
        try:
            ...
            row_cursor += 3
            print(f"[GSTR-9_Vs_3B Analysis] Error getting table_3.1_D value from GSTR-3B: {e}")
        ...
        try:
            ...
            row_cursor += 1
            print(f"[GSTR-9_Vs_3B Analysis] Error getting Table_4_row_N value from GSTR-9: {e}")
        try:
            ...
            row_cursor += 3
            print(f"[GSTR-9_Vs_3B Analysis] Error getting value from GSTR-3B : {e}")
        ...
        try:
            ...
            row_cursor += 1
            print(f"[GSTR-9_Vs_3B Analysis] Error getting value from GSTR-9: {e}")
        try:
        ...
        try:
            ...
            row_cursor += 3
            print(
                f"[GSTR-9_Vs_3B Analysis] Error while Table 9: Tax Payable == Paid through cash + Paid through ITC: {e}")
        ...
        try:
            ...
            row_cursor += 1
            final_result_points["gstr9_unavailable"] = True
            print(f"[GSTR-9_Vs_3B Analysis] Error while Total tax payable derived from GSTR-9 Table 9: {e}")
        try:
            ...
            row_cursor += 1
            final_result_points["gstr3b_unavailable"] = True
            print(f"[GSTR-9_Vs_3B Analysis] Error while Total tax payable derived from GSTR-3B Table 6.1: {e}")
        try:
            tax_mismatch_point_19_IGST = round(
                valuesFrom9["tax_payable_table9_IGST"] - valuesFrom3b["table_6_1_total_tax_payable_IGST"], 2)
            tax_mismatch_point_19_CGST = round(
                valuesFrom9["tax_payable_table9_CGST"] - valuesFrom3b["table_6_1_total_tax_payable_CGST"], 2)
            tax_mismatch_point_19_SGST = round(
                valuesFrom9["tax_payable_table9_SGST"] - valuesFrom3b["table_6_1_total_tax_payable_SGST"], 2)
            tax_mismatch_point_19_CESS = round(
                valuesFrom9["tax_payable_table9_CESS"] - valuesFrom3b["table_6_1_total_tax_payable_CESS"], 2)
            ws.cell(row=row_cursor, column=2, value="Tax mismatch")
            ...
            row_cursor += 3
            print(f"[GSTR-9_Vs_3B Analysis] Error while finding Tax mismatch result_point_19: {e}")
        ...
        try:
            ...
            row_cursor += 3
            print(f"[GSTR-9_Vs_3B Analysis] Error while Result 5.1 = Table 8D + Table 13 from GSTR-9: {e}")
        ...
        print(" === ✅ Returning after execution of file gstr9_Vs_3B_analysis.py ===")
